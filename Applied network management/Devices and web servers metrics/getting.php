...
#"CDEF:aggOut$id$n=outBytes$id$n,+",
  ...
  if (! $ret) {
    echo "<b>Graph error: </b>"."\n".rrd_error()."\n";
				...
				echo "<center><img src='device.png' height='2000' width='800' alt='Generated RRD image' ></center>";
